# Riesgo de Inundación por Parroquia - Ecuador

**URL Pública:** [Ver Aplicación en Vivo](https://projectj2026.pythonanywhere.com)

## Descripción
Este sistema clasifica el riesgo de inundación utilizando Machine Learning (Random Forest/SVM). 
